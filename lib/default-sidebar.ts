...
export const defaultSidebarBlocks: DefaultBlockConfig[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: "planes-patrimoniales", name: "Planes Patrimoniales", icon: "Layers", built: true },
      { slug: "rutas-de-cliente", name: "Rutas de Cliente", icon: "Route", built: false },
      { slug: "componentes", name: "Componentes", icon: "Box", built: false },
      { slug: "biblioteca", name: "Biblioteca", icon: "BookOpen", built: false },
      { slug: "casos-de-uso", name: "Casos de Uso", icon: "Lightbulb", built: false },
      { slug: "calculadora", name: "Calculadora", icon: "Calculator", built: false },
      { slug: "comparador", name: "Comparador", icon: "Scale", built: false },
  ...
  { slug: "productos", name: "Productos", icon: "Package2", pages: [] },
  {
    ...
    pages: [
      ...
      { slug: "revisiones", name: "Revisiones", icon: "ClipboardCheck", built: true },
      { slug: "documentos-pendientes", name: "Documentos Pendientes", icon: "FileText", built: true },
      { slug: "firmas", name: "Firmas", icon: "PenLine", built: true },
      { slug: "renovaciones", name: "Renovaciones", icon: "CalendarClock", built: true },
      { slug: "casos-especiales", name: "Casos Especiales", icon: "ShieldAlert", built: true },
      { slug: "calendario", name: "Calendario", icon: "CalendarDays", built: true },
      { slug: "equipo", name: "Equipo", icon: "Users", built: true },
      { slug: "sla-cumplimiento", name: "SLA y Cumplimiento", icon: "ShieldCheck", built: true },
      { slug: "reportes-operativos", name: "Reportes Operativos", icon: "BarChart3", built: true },
      { slug: "reportes-procesos", name: "Reportes de Procesos", icon: "GitBranch", built: true },
