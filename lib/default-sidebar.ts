...
export const defaultSidebarBlocks: DefaultBlockConfig[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: "rutas-de-cliente", name: "Rutas de Cliente", icon: "Route", built: true },
      { slug: "componentes", name: "Componentes", icon: "Box", built: true },
      { slug: "biblioteca", name: "Biblioteca", icon: "BookOpen", built: true },
