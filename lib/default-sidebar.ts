...
export const defaultSidebarBlocks: DefaultBlockConfig[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: "etiquetas", name: "Etiquetas", icon: "Tags", built: false },
      { slug: "segmentos", name: "Segmentos", icon: "Filter", built: false },
      { slug: "automatizaciones", name: "Automatizaciones", icon: "Zap", built: false },
