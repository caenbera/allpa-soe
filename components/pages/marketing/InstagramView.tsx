...
const initialSections: AccordionSectionData[] = [
  {
    ...
    checklist: [
      { id: "1", text: "Definir objetivo de la cuenta", status: "completado", assignee: "Ana Torres", dueDate: "2026-05-01", notes: [] },
      { id: "2", text: "Definir audiencia objetivo", status: "completado", assignee: "Ana Torres", dueDate: "2026-05-01", notes: [] },
      { id: "3", text: "Análisis de la competencia", status: "completado", assignee: "Luis Peña", dueDate: "2026-05-03", notes: [] },
      { id: "4", text: "Definir pilares de contenido", status: "completado", assignee: "Ana Torres", dueDate: "2026-05-03", notes: [] },
      { id: "5", text: "Calendario de publicaciones", status: "pendiente", assignee: "Luis Peña", dueDate: "2026-05-05", notes: [] },
      { id: "6", text: "Hashtags estrategia", status: "pendiente", assignee: "Luis Peña", dueDate: "2026-05-05", notes: [] },
      { id: "7", text: "Guía de estilo visual", status: "pendiente", assignee: "Ana Torres", dueDate: "2026-05-06", notes: [] },
    ],
  },
  { id: "calendario", title: "2. Calendario de Contenidos", icon: "CalendarDays", status: "en_progreso", priority: "alta", assignees: ["Ana Torres", "Luis Peña"], richContent: "", checklist: [
    { id: "1", text: "Planificar publicaciones del mes", status: "en_progreso", assignee: "Ana Torres", dueDate: "2026-05-08", notes: [] },
  ] },
  { id: "creacion", title: "3. Creación de Contenido", icon: "PenTool", status: "en_revision", priority: "media", assignees: ["Luis Peña"], richContent: "", checklist: [
    { id: "1", text: "Diseñar piezas gráficas", status: "en_revision", assignee: "Luis Peña", dueDate: "2026-05-10", notes: [] },
  ] },
